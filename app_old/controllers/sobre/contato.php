...
class ControllerSobreContato extends BaseController {
  public function index($data = null) {

    $this->document->setTitle('Contato - Multibio Soluções Laboratoriais');

    $this->document->addStyle('pages/contato');
    $this->document->addStyle('pages/faq');
    ...
    $this->response->setOutput($this->load->view('sobre/contato', $data));
  }
}
