        ...
        $.extend(paginga.prototype,
        {
            ...
            bindEvents: function()
            {
                var plugin = this,
                    ...
                    previousElement = $(plugin.settings.previousPage),
                    nextElement = $(plugin.settings.nextPage),
                    firstElement = $(plugin.settings.firstPage),
                    lastElement = $(plugin.settings.lastPage);
